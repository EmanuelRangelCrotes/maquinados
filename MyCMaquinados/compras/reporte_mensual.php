...
<head>
    ...
    <style>
        ...
        /* Título cambia color en modo oscuro */
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="./sesion_usuario.php">Página Principal</a>
                    </li>
                    <li class="nav-item">
    ...
    <button class="btn btn-outline-secondary toggle-theme-btn" onclick="toggleTheme()">🌙/☀️</button>
