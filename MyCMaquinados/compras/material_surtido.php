...
<head>
    ...
    <style>
        /* Solo cambiar el fondo en modo oscuro, sin alterar colores de texto o botones */
        body.dark-mode {
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="reporte_mensual.php">Reporte mensaul</a>
                    </li>
                    <li class="nav-item">
    ...
    <button class="btn btn-outline-secondary" style="position: fixed; top: 10px; right: 10px; z-index: 999;" onclick="toggleTheme()">🌙/☀️</button>
