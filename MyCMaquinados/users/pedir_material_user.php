...
if (!isset($_SESSION['logged_in'], $_SESSION['id_usuario'], $_SESSION['rol']) || $_SESSION['rol'] !== 'tecnico') {
    exit();
}
                            ...
                            <form method="post" action="procesar_solicitud.php" id="solicitudForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="cantidad" id="cantidad_solicitud"
                                        min="1" required>
                                    <small class="text-muted">Puedes solicitar más que la existencia actual si es
                                        necesario.</small>
                                </div>
                            </form>
                        </div>
                        ...
                        .then(data => {
                            ...
                            data.forEach(item => {
                                ...
                                btn.addEventListener('click', () => {
                                    ...
                                    document.getElementById('id_productos').value = item
                                        .id_productos;
                                    document.getElementById('material_nombre').value =
                                        item.nombre;
                                    document.getElementById('material_clase').value =
                                        item.clase;
                                    document.getElementById('material_descripcion')
                                        .value = item.descripcion;
                                    document.getElementById('material_existencia')
